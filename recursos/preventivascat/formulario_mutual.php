...
if ($response["authenticated"]) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        try {
            ...
            //ultimo n de solicitud (el general) para crear el siguiente
            ...
            foreach ($datos_tabla as $fila) {
                ...
                tipo_solicitud_id, n_solicitud,ingresado,valido,direccion,edad,tipo_examen_id,tipo_formulario,tipo_genero_id,cod_solicitud) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?,?)");
                ...
                $stmt->bindParam(17, $num_codsolicitud, PDO::PARAM_STR);
